...
;// CONCATENATED MODULE: ./libs/RunExtend.mjs
...
/* harmony default export */ function RunExtend($) {
    dateToString($);
    typeToString($);
    querytoObj($);
}
...
(function () {
  ...
  config.onsave = function (cfg) {
    conf = cfg;
    (0,jquery.jquery)("#autogetnextpage").text("自动获取" + getAutoNextPagesCount() + "页");
  };
