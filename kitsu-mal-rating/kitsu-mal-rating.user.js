      ...
      if (!malId) {
        ...
        App.getMalPage(malLink, function (rating) {
          ...
          if (malBarCheck) {
            ...
            rating
              ? (updateRating.firstChild.textContent = rating + '% MAL Approval')
              : (updateRating.firstChild.textContent = 'Unknown MAL Approval')
          } else {
            ...
            rating
              ? (ratingLink.textContent = rating + '% MAL Approval')
              : (ratingLink.textContent = 'Unknown MAL Approval')
